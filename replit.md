...
- **Data Models**: User (authentication, role-based access), Patient (18-column data + 9 N8N-specific fields, alert status), ImportHistory, NursingUnitTemplate (customizable templates with field configuration).
